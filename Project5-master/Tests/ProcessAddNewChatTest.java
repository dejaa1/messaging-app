...
public class ProcessAddNewChatTest {
    ...
    public static class TestCase {
       ...
       // private ArrayList<Userthread> userthreads = new ArrayList<Userthread>();
        ...
        public void initializeFields() {
            ...
            users.add(user2);
            users.add(user3);
            groupChat = new Chat(messages, users, true);
        }

        //constructor
        private ProcessAddNewChat processAddNewChat = new ProcessAddNewChat(user1, groupChat);
        //Problem

        @Test
        public void testClassExists() {
            try {
                Class.forName("ProcessAddNewChat");
        ...
        public void testFieldsExist() {
            try {
                User user = processAddNewChat.getUser();
                Chat chat = processAddNewChat.getChat();
