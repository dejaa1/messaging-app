...
public class ProcessGetNewMessagesTest {
      ...
      //  private Userthread userthread2 = new Userthread(socket, messageServer);
       ...
       // private ArrayList<Userthread> userthreads = new ArrayList<Userthread>();
        ...
        public void initializeFields() {
            ...
            users.add(user3);
            //@TODO we are not using user thread
           // userthreads.add(userthread1);
          //  userthreads.add(userthread2);
          //  userthreads.add(userthread3);
           // groupChat = new Chat("Group Chat", messages, users, userthreads);
        }

        //constructor
        //@TODO Added null
        private ProcessGetNewMessages processGetNewMessages = new ProcessGetNewMessages(groupChat, new JScrollPane(),null);

        @Test
        public void testClassExists() {
            try {
                Class.forName("ProcessGetNewMessages");
        ...
        public void testFieldsExist() {
            try {
                Chat currentChat = processGetNewMessages.getCurrentChat();
