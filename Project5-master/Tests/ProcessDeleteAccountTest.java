...
public class ProcessDeleteAccountTest {
    ...
    public static class TestCase {
        ...
        //constructor
        private ProcessDeleteAccount deleteTest = new ProcessDeleteAccount("exampleUID", frame);
        //Problem
        ...
        public void testFieldsExist() {
            try {
                String UID = deleteTest.getUid();
                deleteTest.setUid("exampleUIDTest2");
